...
- Removed support for old tokens generated by Saleor <3.21.65, <3.22.59, and <3.23.18
  for the following mutations: `accountDelete()`, `confirmAccount()`, and `setPassword()`.
