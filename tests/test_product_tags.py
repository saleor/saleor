...
from dastkari.product.templatetags.product_images import (
    choose_placeholder,
...
def test_get_thumbnail_no_instance(monkeypatch):
    monkeypatch.setattr(
        "dastkari.product.templatetags.product_images.choose_placeholder",
...
@patch(
    "dastkari.product.templatetags.product_images.AVAILABLE_SIZES",
    {
        "products": (
            "thumbnail__800x800",
            "crop__100x100",
