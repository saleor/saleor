...
from dastkari.plugins.checks import check_plugins


@pytest.mark.parametrize(
    "manager_path", [None, "", "dastkari.core.plugins.wrong_path.Manager"]
)
...
@pytest.mark.parametrize(
    "plugin_path", [None, "", "dastkari.core.plugins.wrong_path.Plugin"]
)
