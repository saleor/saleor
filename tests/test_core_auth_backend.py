...
from saleor.core.auth_backend import JSONWebTokenBackend
...
from saleor.settings import JWT_EXPIRATION_DELTA
...
def test_incorrect_token(rf, staff_user):
    payload = jwt_user_payload(staff_user, JWT_ACCESS_TYPE, JWT_EXPIRATION_DELTA,)
