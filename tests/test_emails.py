...
import saleor.csv.emails as csv_emails
...
def test_send_email_with_link_to_download_csv(
    ...
    csv_emails.send_email_with_link_to_download_csv(
        export_file, "export_products_success"
    )
    template = csv_emails.EXPORT_TEMPLATES["export_products_success"]
    ctx = {
...
def test_send_export_failed_info(
    ...
    csv_emails.send_export_failed_info(export_file, "export_failed")
    template = csv_emails.EXPORT_TEMPLATES["export_failed"]
    ctx = {
        "domain": "mirumee.com",
        "site_name": "mirumee.com",
    }
