...
def test_staff_can_view_sale_list(
        staff_client, staff_user, permission_edit_sale):
...
def test_staff_can_view_order_list(
        staff_client, staff_user, permission_edit_order):
...
def test_staff_can_view_order_details(
        staff_client, staff_user, permission_edit_order, order_with_lines):
    assert not staff_user.has_perm('order.edit_order')
    response = staff_client.get(
...
def test_staff_can_view_customers_list(
        staff_client, staff_user, permission_edit_user):
    assert not staff_user.has_perm('account.edit_user')
...
def test_staff_can_view_customer_details(
        staff_client, staff_user, permission_edit_user, customer_user,
        order_with_lines):
    assert not staff_user.has_perm('account.edit_user')
    response = staff_client.get(
...
def test_staff_with_permissions_can_view_product_types_list(
        staff_client, staff_user, permission_edit_properties):
...
def test_staff_can_view_menus_and_details(
    ...
    assert not staff_user.has_perm('menu.edit_menu')
