...
from saleor.payment.gateways.braintree.errors import (
    BraintreeException, DEFAULT_ERROR_MESSAGE)
...
def test_authorize_error_response(
    ...
    response = authorize(payment_info)
