...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippedDeliveryGroup.address'
        db.alter_column(u'order_shippeddeliverygroup', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.Address'], null=True))

    def backwards(self, orm):

        # Changing field 'ShippedDeliveryGroup.address'
        db.alter_column(u'order_shippeddeliverygroup', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['userprofile.Address']))
    ...
    models = {
        ...
        u'order.shippeddeliverygroup': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['userprofile.Address']", 'null': 'True', 'blank': 'True'}),
            u'deliverygroup_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['order.DeliveryGroup']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'product.category': {
