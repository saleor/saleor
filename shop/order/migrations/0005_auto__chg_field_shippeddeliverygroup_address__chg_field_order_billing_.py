...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'order_order', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['userprofile.Address']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.billing_address'
        db.alter_column(u'order_order', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.Address'], null=True))
