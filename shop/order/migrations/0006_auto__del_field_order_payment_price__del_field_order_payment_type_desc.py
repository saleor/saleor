...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'order_order', 'payment_price')

        # Deleting field 'Order.payment_type_description'
        db.delete_column(u'order_order', 'payment_type_description')

        # Deleting field 'Order.payment_type_name'
        db.delete_column(u'order_order', 'payment_type_name')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'order_order', 'payment_price',
                      self.gf('django_prices.models.PriceField')(default=0, currency='USD', max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding field 'Order.payment_type_description'
        db.add_column(u'order_order', 'payment_type_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Order.payment_type_name'
        db.add_column(u'order_order', 'payment_type_name',
