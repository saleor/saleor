...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'userprofile_user', 'default_billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['userprofile.AddressBook']))

        # Changing field 'User.default_shipping_address'
        db.alter_column(u'userprofile_user', 'default_shipping_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['userprofile.AddressBook']))
