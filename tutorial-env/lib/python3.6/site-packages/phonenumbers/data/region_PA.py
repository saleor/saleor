...
PHONE_METADATA_PA = PhoneMetadata(id='PA', country_code=507, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:[1-57-9]|6\\d)\\d{6}', possible_length=(7, 8)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:1[16]1|21[89]|6(?:[02-9]\\d|1[0-6])\\d|8(?:1[01]|7[23]))\\d{4}', example_number='61234567', possible_length=(7, 8)),
