...
PHONE_METADATA_IL = PhoneMetadata(id='IL', country_code=972, international_prefix='0(?:0|1[2-9])',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='153\\d{8,9}|[2-489]\\d{7}', example_number='21234567', possible_length=(8, 11, 12), possible_length_local_only=(7,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='78(?:33|55|77|81)\\d{5}|7(?:18|2[23]|3[237]|47|6[58]|7\\d|82|9[2357-9])\\d{6}', example_number='771234567', possible_length=(9,)),
