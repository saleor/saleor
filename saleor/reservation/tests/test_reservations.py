...
from ..stock import (
    get_reserved_quantity, get_reserved_quantity_bulk, remove_user_reservations
)

COUNTRY_CODE = "US"


def test_zero_reservations_are_returned_for_variant_without_any_reservations(
    variant
):
...
def test_user_reservations_are_removed(
    variant_with_reserved_stock, customer_user
):
