    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(max_length=256, verbose_name='company name', blank=True)),
                ('street_address_1', models.CharField(max_length=256, verbose_name='street address 1')),
                ('street_address_2', models.CharField(max_length=256, verbose_name='street address 2', blank=True)),
                ...
                ('country_area', models.CharField(max_length=128, verbose_name='country administrative area', blank=True)),
