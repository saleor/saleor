...
subscription {
  orderPaid(channels: ["default-channel"]) {
    order {
      id
      number
      lines {
...
def test_order_paid(order_line, subscription_webhook):
    # given
    ...
    webhook = subscription_webhook(ORDER_PAID_SUBSCRIPTION, event_type)
...
def test_order_paid_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_order_paid_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
