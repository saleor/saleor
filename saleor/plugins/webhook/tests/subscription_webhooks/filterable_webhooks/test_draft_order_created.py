...
def test_draft_order_created(order_line, subscription_webhook):
    # given
...
def test_draft_order_created_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_draft_order_created_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
