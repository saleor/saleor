...
def test_order_cancelled(order_line, subscription_webhook):
    # given
...
def test_order_cancelled_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_order_cancelled_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
