...
def test_order_expired(order_line, subscription_webhook):
    # given
...
def test_order_expired_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_order_expired_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
