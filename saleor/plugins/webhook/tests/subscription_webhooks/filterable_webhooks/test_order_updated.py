...
def test_order_updated(order_line, subscription_webhook):
    # given
    ...
    webhook = subscription_webhook(ORDER_UPDATED_SUBSCRIPTION, event_type)
...
def test_order_updated_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
    event_type = WebhookEventAsyncType.ORDER_UPDATED
...
def test_order_updated_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
