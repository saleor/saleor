...
def test_order_confirmed(order_line, subscription_webhook):
    # given
    ...
    webhook = subscription_webhook(ORDER_CONFIRMED_SUBSCRIPTION, event_type)
...
def test_order_confirmed_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_order_confirmed_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
