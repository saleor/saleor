...
subscription {
  orderFullyRefunded(channels: ["default-channel"]) {
    order {
      id
      number
      lines {
...
def test_order_fully_refunded(order_line, subscription_webhook):
    # given
    ...
    webhook = subscription_webhook(ORDER_FULLY_REFUNDED_SUBSCRIPTION, event_type)
...
def test_order_fully_refunded_without_channels_input(order_line, subscription_webhook):
    # given
    order = order_line.order
...
def test_order_fully_refunded_with_different_channel(order_line, subscription_webhook):
    # given
    order = order_line.order
    channel = order.channel
