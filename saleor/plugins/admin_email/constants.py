...
STAFF_ORDER_CONFIRMATION_TITLE_FIELD = "staff_order_confirmation_title"
SET_STAFF_PASSWORD_TITLE_FIELD = "set_staff_password_title"
CSV_PRODUCT_EXPORT_SUCCESS_TITLE_FIELD = "csv_product_export_success_title"
CSV_EXPORT_FAILED_TITLE_FIELD = "csv_export_failed_title"


STAFF_ORDER_CONFIRMATION_DEFAULT_TITLE = "Order {{ order.id }} details"
SET_STAFF_PASSWORD_DEFAULT_TITLE = "Password reset e-mail"
CSV_PRODUCT_EXPORT_SUCCESS_DEFAULT_TITLE = "Export products data"
