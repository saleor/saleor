...
ORDER_CONFIRMATION_DEFAULT_SUBJECT = "Order #{{ id }} details"
ORDER_FULFILLMENT_CONFIRMATION_DEFAULT_SUBJECT = (
    "Your order {{ id }} has been fulfilled"
)
ORDER_FULFILLMENT_UPDATE_DEFAULT_SUBJECT = "Shipping update for order {{ id }}"
ORDER_PAYMENT_CONFIRMATION_DEFAULT_SUBJECT = "Order {{ id }} payment details"
ORDER_CANCELED_DEFAULT_SUBJECT = "Order {{ id }} canceled"
ORDER_REFUND_CONFIRMATION_DEFAULT_SUBJECT = "Order {{ id }} refunded"
