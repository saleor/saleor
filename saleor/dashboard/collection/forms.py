    ...
    class Meta:
        ...
        labels = {
            ...
            "background_image": pgettext_lazy(
                "Background image of a collection", "Background image"
            ),
            "background_image_alt": pgettext_lazy(
                "Description of a collection image", "Image description"
            ),
            "is_published": pgettext_lazy("Collection published toggle", "Published"),
            ...
            "description": pgettext_lazy(
                "Description field of a collection", "Description"
            ),
        }
...
class AssignHomepageCollectionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["homepage_collection"].queryset = Collection.objects.filter(
            is_published=True
        )
