          ...
          {sortedValue ? (
            sortedValue.search('-') ? (
              <div>
                ...
                <img src={arrowUpIcon} width="15" />
              </div>
            ) : (
               <div>
                <span>Sort by: <strong>{sortedValue.replace('-','')}</strong></span>
                <img src={arrowDownIcon} width="15" />
              </div>
            )
          ) : (
          ...
          <li className="name">
            <div className="row">
              ...
              <div className="col-md-6">
                  ...
                  <img className="float-right" src={arrowUpIcon} width="15" />
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-md-6">
                  ...
                  <img className="float-right" src={arrowDownIcon} width="15" />
              </div>
            </div>
          </li>
          <li className="price">
