...
export interface OrderLineDelete_draftOrderLineDelete_order_billingAddress {
  ...
  cityArea: string;
  companyName: string;
  country: OrderLineDelete_draftOrderLineDelete_order_billingAddress_country | null;
  countryArea: string;
  firstName: string;
  lastName: string;
  phone: string | null;
...
export interface OrderLineDelete_draftOrderLineDelete_order_shippingAddress {
  ...
  cityArea: string;
  companyName: string;
  country: OrderLineDelete_draftOrderLineDelete_order_shippingAddress_country | null;
  countryArea: string;
  firstName: string;
  lastName: string;
  phone: string | null;
