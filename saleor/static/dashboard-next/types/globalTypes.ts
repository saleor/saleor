...
export enum PermissionEnum {
  ACCOUNT_IMPERSONATE_USERS = "ACCOUNT_IMPERSONATE_USERS",
  ACCOUNT_MANAGE_STAFF = "ACCOUNT_MANAGE_STAFF",
  ACCOUNT_MANAGE_USERS = "ACCOUNT_MANAGE_USERS",
  DISCOUNT_MANAGE_DISCOUNTS = "DISCOUNT_MANAGE_DISCOUNTS",
  MENU_MANAGE_MENUS = "MENU_MANAGE_MENUS",
  ORDER_MANAGE_ORDERS = "ORDER_MANAGE_ORDERS",
  PAGE_MANAGE_PAGES = "PAGE_MANAGE_PAGES",
  PRODUCT_MANAGE_PRODUCTS = "PRODUCT_MANAGE_PRODUCTS",
  SHIPPING_MANAGE_SHIPPING = "SHIPPING_MANAGE_SHIPPING",
  SITE_MANAGE_SETTINGS = "SITE_MANAGE_SETTINGS",
}
