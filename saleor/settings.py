...
AVATAX_CHECKOUT_CACHE_TIME = os.environ.get("AVATAX_CHECKOUT_CACHE_TIME", 60 * 60)
AVATAX_TAX_CODE_CACHE_TIME = os.environ.get("AVATAX_TAX_CODE_CACHE_TIME", 24 * 60 * 60)
