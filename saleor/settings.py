...
APP_CONCURRENCY_SEQUENTIAL = int(os.environ.get("APP_CONCURRENCY_SEQUENTIAL", 1))
APP_CONCURRENCY_LOW = int(os.environ.get("APP_CONCURRENCY_LOW", 3))
APP_CONCURRENCY_NORMAL = int(os.environ.get("APP_CONCURRENCY_NORMAL", 6))
APP_CONCURRENCY_HIGH = int(os.environ.get("APP_CONCURRENCY_HIGH", 10))
