...
def test_checkout_with_fixed_promotion_should_not_result_in_negative_price_CORE_2111(
    ...
    # Step 1 - Create fixed promotion for the products
    ...
    for product_id in product_ids:
        ...
        expected_discount = min(variant_price, discount_value)
    ...
    assert order_line3["unitDiscountReason"] == f"Promotion: {promotion_id}"
    assert (
