...
def prepare_promotion_for_products(
...
def test_checkout_products_on_fixed_promotion_core_2102(
    ...
    promotion_id = prepare_promotion_for_products(
        e2e_staff_api_client,
        channel_id,
        product_ids,
    ...
    line1_unit_price = product1_variant_price - fixed_discount_value
    ...
    line2_unit_price = product2_variant_price - fixed_discount_value
    ...
    line3_unit_price = product3_variant_price - fixed_discount_value
    ...
    new_checkout_line3 = checkout_data["lines"][2]  # not on promotion

    assert new_checkout_line1["variant"]["id"] == product2_variant_id
    assert new_checkout_line1["quantity"] == product2_quantity
    line1_unit_price = product2_variant_price - fixed_discount_value
    ...
    line2_unit_price = product3_variant_price - fixed_discount_value
    ...
    checkout_line1 = checkout_data["lines"][0]
    checkout_line2 = checkout_data["lines"][1]
    checkout_line3 = checkout_data["lines"][2]  # not on promotion
    ...
    assert order_line1["unitDiscount"]["amount"] == fixed_discount_value
    assert order_line1["unitDiscountReason"] == f"Promotion: {promotion_id}"
    assert (
    ...
    assert order_line2["unitDiscount"]["amount"] == fixed_discount_value
    assert order_line2["unitDiscountReason"] == f"Promotion: {promotion_id}"
    assert (
