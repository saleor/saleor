...
def prepare_promotion_for_products(
    ...
    return promotion_id, discount_value
...
def test_checkout_products_on_percentage_promotion_core_2104(
    ...
    promotion_id, discount_value = prepare_promotion_for_products(
        e2e_staff_api_client,
        channel_id,
        product_ids,
        discount_type=RewardValueTypeEnum.PERCENTAGE.name,
        discount_value=3,
    )
    ...
    line1_discount = round(product1_variant_price * discount_value / 100, 2)
    ...
    line2_discount = round(product2_variant_price * discount_value / 100, 2)
    ...
    line3_discount = round(product3_variant_price * discount_value / 100, 2)
    ...
    line1_discount = round(product2_variant_price * discount_value / 100, 2)
    ...
    line2_discount = round(product3_variant_price * discount_value / 100, 2)
