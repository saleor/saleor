...
def test_base_checkout_total(
    checkout_with_item, checkout_shipping_method, shipping_method, voucher_percentage
):
    # given
...
def test_base_checkout_total_high_discount_on_shipping(
    checkout_with_item, shipping_method, voucher_shipping_type, checkout_shipping_method
):
    # given
    manager = get_plugins_manager(allow_replica=False)
...
def test_base_checkout_total_order_discount(
    checkout_with_item_and_order_discount, shipping_method, checkout_shipping_method
):
    # given
    manager = get_plugins_manager(allow_replica=False)
...
def test_base_checkout_total_gift_promotion(
    checkout_with_item_and_gift_promotion, shipping_method, checkout_shipping_method
):
    # given
    manager = get_plugins_manager(allow_replica=False)
