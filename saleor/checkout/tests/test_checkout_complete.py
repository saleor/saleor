...
def test_complete_checkout_checkout_limited_use_voucher_multiple_thread(
    ...
    voucher_free_shipping.refresh_from_db()
    assert voucher_free_shipping.used == 1
...
def test_increase_checkout_voucher_usage(
    ...
    # when
    _increase_checkout_voucher_usage(checkout_with_voucher, voucher, None)
...
@mock.patch("saleor.checkout.complete_checkout.release_voucher_usage")
def test_release_checkout_voucher_usage(
    ...
    # when
    _release_checkout_voucher_usage(checkout_with_voucher, voucher, None)
...
def test_release_checkout_voucher_usage_no_voucher(
    ...
    # when
    _release_checkout_voucher_usage(checkout_with_voucher, None, None)
