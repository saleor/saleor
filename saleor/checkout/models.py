...
# Checkout metadata is moved to separate model so when the checkout model is locked
# during complete_checkout, its metadata can be freely modified with webhooks.
