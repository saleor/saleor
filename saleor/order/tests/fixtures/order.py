...
def preorders(orders, product):
    ...
    variants[0].preorder_end_date = timezone.now() + timedelta(days=1)
    variants[1].preorder_end_date = timezone.now()
    variants[2].preorder_end_date = timezone.now() - timedelta(days=1)
