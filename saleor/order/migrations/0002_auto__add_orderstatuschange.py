...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderStatusChange'
        db.create_table(u'order_orderstatuschange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'status_history', to=orm['order.Order'])),
        ...
        db.send_create_signal(u'order', ['OrderStatusChange'])


    def backwards(self, orm):
        # Deleting model 'OrderStatusChange'
        db.delete_table(u'order_orderstatuschange')
    ...
    models = {
        ...
        u'order.orderstatuschange': {
            'Meta': {'object_name': 'OrderStatusChange'},
