...
class OrderEvents:
    ...
    CHOICES = [
        ...
        (PAYMENT_CAPTURE_REQUESTED, "The capture on payment requested"),
        (PAYMENT_REFUND_REQUESTED, "The refund on payment requested"),
        (PAYMENT_VOID_REQUESTED, "The void on payment requested"),
