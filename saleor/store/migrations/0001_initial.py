    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('description', saleor.core.db.fields.SanitizedJSONField(blank=True, null=True, sanitizer=saleor.core.utils.editorjs.clean_editor_js)),
                ('store_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='store.storecategory')),
            ],
        ),
        migrations.AddIndex(
            model_name='storecategory',
            index=django.contrib.postgres.indexes.GinIndex(fields=['private_metadata'], name='storecategory_p_meta_idx'),
        ),
        migrations.AddIndex(
            model_name='storecategory',
            index=django.contrib.postgres.indexes.GinIndex(fields=['metadata'], name='storecategory_meta_idx'),
        ),
        migrations.AddField(
            model_name='store',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stores', to='store.storecategory'),
        ),
