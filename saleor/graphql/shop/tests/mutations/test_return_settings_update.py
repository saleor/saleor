...
def test_no_permission_customer(user_api_client, page_type):
    # given
    page_type_id = graphene.Node.to_global_id("PageType", page_type.id)
    variables = {"input": {"returnReasonReferenceType": page_type_id}}
...
def test_no_permission_anonymous(api_client, page_type):
    # given
    page_type_id = graphene.Node.to_global_id("PageType", page_type.id)
    variables = {"input": {"returnReasonReferenceType": page_type_id}}
...
def test_app_no_permission(app_api_client, page_type):
    # given
    page_type_id = graphene.Node.to_global_id("PageType", page_type.id)
    variables = {"input": {"returnReasonReferenceType": page_type_id}}
