...
from alter_product.graphql.schema import AlternativeProductMutations\
    , AlterOrderLineMutations, AlternativeOrderQuerries
...
class Mutation(
    ...
    WarehouseMutations,
    WebhookMutations,
    AlternativeProductMutations,
    AlterOrderLineMutations,
):
    pass
