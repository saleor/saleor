...
def test_checkout_customer_attach_deleted_database_error(
    user_api_client,
    checkout_with_item,
    customer_user2,
    permission_impersonate_user,
    ...
    # then
    data = get_graphql_content(response)["data"]["checkoutCustomerAttach"]
    errors = data["errors"]
...
def test_checkout_customer_attach_raise_error_which_inherits_from_database_error(
    user_api_client,
    checkout_with_item,
    customer_user2,
    permission_impersonate_user,
