...
def test_checkout_customer_detach_deleted_database_error(
    user_api_client,
    checkout_with_item,
    customer_user2,
    ...
    with before_after.before(
        (
            ...
            "checkout_customer_detach.save_checkout_with_update_fields"
        ),
    ...
    # then
    data = get_graphql_content(response)["data"]["checkoutCustomerDetach"]
    errors = data["errors"]
...
def test_checkout_customer_detach_raise_error_which_inherits_from_database_error(
    user_api_client,
    checkout_with_item,
    customer_user2,
    permission_impersonate_user,
