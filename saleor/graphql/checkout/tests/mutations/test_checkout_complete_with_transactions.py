...
def test_checkout_with_charged(
    ...
    assigned_checkout_shipping = checkout.assigned_shipping_method
    assert checkout_line_quantity == order_line.quantity
    assert checkout_line_variant == order_line.variant
    ...
    assert order.shipping_address == address
    assert order.shipping_method.id == assigned_checkout_shipping.original_id
    assert order.shipping_tax_rate is not None
...
def test_checkout_with_voucher_not_applicable(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_item_and_voucher),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_with_insufficient_stock(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_item),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_with_gift_card_not_applicable(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_gift_card),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_gift_card_bought(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_gift_card_items),
        transaction_item_generator,
        transaction_events_generator,
    )
    checkout.metadata_storage.store_value_in_metadata(items={"accepted": "true"})
...
def test_checkout_complete_with_shipping_voucher_and_gift_card(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_gift_card, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
...
def test_checkout_with_voucher_complete(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_voucher_percentage, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_with_order_promotion_complete(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_product_on_promotion(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_item, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_with_preorder_variant(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_item_and_preorder_item, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_variant_channel_listing_does_not_exist(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_items, shipping_method),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_log_unknown_discount_reason(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address,
        checkout_shipping_method(checkout_with_item_and_voucher_specific_products),
        transaction_item_generator,
        transaction_events_generator,
    )
...
def test_checkout_complete_with_external_shipping_method(
    ...
    checkout.assigned_shipping_method = CheckoutShippingMethod.objects.create(
        checkout=checkout,
        original_id=graphql_externa_method_id,
        name=external_shipping_name,
        price_amount="10.00",
        currency="USD",
        maximum_delivery_days=7,
...
def test_checkout_complete_with_different_email_than_user_email(
    ...
    checkout = prepare_checkout_for_test(
        ...
        address,
        address_usa,
        checkout_ready_to_complete.assigned_shipping_method,
        transaction_item_generator,
        transaction_events_generator,
        user=customer_user,
        save_billing_address=True,
