...
@patch("saleor.product.tasks.update_products_discounted_prices_of_discount_task.delay")
@patch("saleor.plugins.manager.PluginsManager.sale_toggle")
@patch("saleor.plugins.manager.PluginsManager.sale_created")
def test_create_sale(
    created_webhook_mock,
    sale_toggle_mock,
    update_products_discounted_prices_of_discount_task_mock,
    staff_api_client,
    ...
    update_products_discounted_prices_of_discount_task_mock.assert_called_once_with(
        sale.id
    )
...
def test_create_sale_with_end_date_before_startdate(
    ...
    update_products_discounted_prices_of_discount_task_mock.assert_not_called()
