...
def menus_for_pagination(db):
    ...
    return Menu.objects.bulk_create(
        [
            Menu(name="menu1", slug=str(uuid.uuid4())),
            Menu(name="menuMenu1", slug=str(uuid.uuid4())),
            Menu(name="menuMenu2", slug=str(uuid.uuid4())),
            Menu(name="menu2", slug=str(uuid.uuid4())),
            Menu(name="menu3", slug=str(uuid.uuid4())),
        ]
    )
