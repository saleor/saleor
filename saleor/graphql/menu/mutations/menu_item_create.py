...
class MenuItemMutationBase(DeprecatedModelMutation):
    class Meta:
        abstract = True
...
@doc(category=DOC_CATEGORY_MENU)
@webhook_events(async_events={WebhookEventAsyncType.MENU_ITEM_CREATED})
class MenuItemCreate(MenuItemMutationBase):
