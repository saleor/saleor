...
class AttributeValueTranslation(
    ...
    id = graphene.GlobalID(
        required=True, description="ID of the attribute value translation."
    )
    name = graphene.String(
        required=True, description="Translated name of the attribute value."
    )
    rich_text = JSONString(description="Translated attribute value." + RICH_CONTENT)
    plain_text = graphene.String(description="Translated attribute plain text value.")
...
class AttributeTranslation(BaseTranslationType[attribute_models.AttributeTranslation]):
    id = graphene.GlobalID(
        required=True, description="ID of the attribute translation."
    )
    name = graphene.String(
        required=True, description="Translated name of the attribute."
    )
...
class AttributeTranslatableContent(ModelObjectType[attribute_models.Attribute]):
    id = graphene.GlobalID(
        required=True, description="ID of the attribute translatable content."
    )
    name = graphene.String(required=True, description="Name of the attribute.")
...
class AttributeValueTranslatableContent(
    ...
    id = graphene.GlobalID(
        required=True, description="ID of the attribute value translatable content."
    )
    name = graphene.String(required=True, description="Name of the attribute value.")
...
class ProductVariantTranslation(
    ...
    id = graphene.GlobalID(
        required=True, description="ID of the product variant translation."
    )
    name = graphene.String(
        required=True, description="Translated name of the product variant."
    )
...
class ProductVariantTranslatableContent(ModelObjectType[product_models.ProductVariant]):
    id = graphene.GlobalID(
        required=True, description="ID of the product variant translatable content."
    )
    name = graphene.String(required=True, description="Name of the product variant.")
    translation = TranslationField(
...
class ProductTranslation(BaseTranslationType[product_models.ProductTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the product translation.")
    seo_title = graphene.String(description="Translated SEO title of the product.")
    seo_description = graphene.String(
        description="Translated SEO description of the product."
    )
    name = graphene.String(description="Translated name of the product.")
...
class ProductTranslatableContent(ModelObjectType[product_models.Product]):
    id = graphene.GlobalID(
        required=True, description="ID of the product translatable content."
    )
...
class CollectionTranslation(BaseTranslationType[product_models.CollectionTranslation]):
    id = graphene.GlobalID(
        required=True, description="ID of the collection translation."
    )
    seo_title = graphene.String(description="Translated SEO title of the collection.")
    seo_description = graphene.String(
        description="Translated SEO description of the collection."
    )
    name = graphene.String(description="Translated name of the collection.")
    description = JSONString(
...
class CollectionTranslatableContent(ModelObjectType[product_models.Collection]):
    id = graphene.GlobalID(
        required=True, description="ID of the collection translatable content."
    )
...
class CategoryTranslation(BaseTranslationType[product_models.CategoryTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the category translation.")
    seo_title = graphene.String(description="Translated SEO title of the category.")
    seo_description = graphene.String(
        description="Translated SEO description of the category."
    )
    name = graphene.String(description="Translated name of the category.")
    description = JSONString(
...
class CategoryTranslatableContent(ModelObjectType[product_models.Category]):
    id = graphene.GlobalID(
        required=True, description="ID of the category translatable content."
    )
    seo_title = graphene.String(description="SEO title of the category.")
    seo_description = graphene.String(description="SEO description of the category.")
...
class PageTranslation(BaseTranslationType[page_models.PageTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the page translation.")
    seo_title = graphene.String(description="Translated SEO title of the page.")
    seo_description = graphene.String(
        description="Translated SEO description of the page."
    )
    title = graphene.String(description="Translated title of the page.")
...
class PageTranslatableContent(ModelObjectType[page_models.Page]):
    id = graphene.GlobalID(
        required=True, description="ID of the page translatable content."
    )
    seo_title = graphene.String(description="SEO title of the page.")
    seo_description = graphene.String(description="SEO description of the page.")
...
class VoucherTranslation(BaseTranslationType[discount_models.VoucherTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the voucher translation.")
    name = graphene.String(description="Translated name of the voucher.")
...
class VoucherTranslatableContent(ModelObjectType[discount_models.Voucher]):
    id = graphene.GlobalID(
        required=True, description="ID of the voucher translatable content."
    )
    name = graphene.String(description="Name of the voucher.")
...
class SaleTranslation(BaseTranslationType[discount_models.SaleTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the sale translation.")
...
class SaleTranslatableContent(ModelObjectType[discount_models.Sale]):
    id = graphene.GlobalID(
        required=True, description="ID of the sale translatable content."
    )
    name = graphene.String(required=True, description="Name of the sale.")
...
class ShopTranslation(BaseTranslationType[site_models.SiteSettingsTranslation]):
    id = graphene.GlobalID(required=True, description="ID of the shop translation.")
    header_text = graphene.String(
        required=True, description="Translated header text of the shop."
    )
    description = graphene.String(
        required=True, description="Translated description of the shop."
    )
...
class MenuItemTranslation(BaseTranslationType[menu_models.MenuItemTranslation]):
    id = graphene.GlobalID(
        required=True, description="ID of the menu item translation."
    )
    name = graphene.String(
        required=True, description="Translated name of the menu item."
    )
...
class MenuItemTranslatableContent(ModelObjectType[menu_models.MenuItem]):
    id = graphene.GlobalID(
        required=True, description="ID of the menu item translatable content."
    )
    name = graphene.String(required=True, description="Name of the menu item.")
...
class ShippingMethodTranslation(
    ...
    id = graphene.GlobalID(
        required=True, description="ID of the shipping method translation."
    )
    name = graphene.String(description="Translated name of the shipping method.")
    description = JSONString(
...
class ShippingMethodTranslatableContent(
    ...
    id = graphene.GlobalID(
        required=True, description="ID of the shipping method translatable content."
    )
