...
@mock.patch(
    "saleor.graphql.shipping.bulk_mutations.shipping_price_bulk_delete.get_webhooks_for_event"
)
...
@mock.patch(
    "saleor.graphql.shipping.bulk_mutations.shipping_zone_bulk_delete.get_webhooks_for_event"
)
@mock.patch("saleor.plugins.webhook.plugin.trigger_webhooks_async")
