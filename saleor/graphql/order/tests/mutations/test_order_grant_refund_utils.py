...
class TestResolveReasonReferencePage:
    def test_resolves_valid_page(self, refund_page_type, refund_page):
        # Given
    ...
    def test_raises_graphql_error_for_wrong_type_id(self, refund_page_type):
        # Given
    ...
    def test_raises_invalid_for_wrong_page_type(self, refund_page_type):
        # Given
    ...
    def test_raises_invalid_for_nonexistent_page(self, refund_page_type):
        # Given
...
class TestResolvePerLineReasonReferences:
    def test_resolves_reason_references_for_lines(
        self, refund_page_type, refund_page, order_with_lines
    ):
        # Given
    ...
    def test_skips_lines_without_reason_reference(
        self, refund_page_type, order_with_lines
    ):
        # Given
        order_line = order_with_lines.lines.first()
        line = models.OrderGrantedRefundLine(
    ...
    def test_raises_not_configured_when_type_missing(self, order_with_lines):
        # Given
    ...
    def test_raises_invalid_for_wrong_page_type_in_line(
        self, refund_page_type, order_with_lines
    ):
        # Given
        other_type = PageType.objects.create(name="Other", slug="other")
    ...
    def test_batches_db_queries(
        self, refund_page_type, order_with_lines, django_assert_num_queries
    ):
        # Given
