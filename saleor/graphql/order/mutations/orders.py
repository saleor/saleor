...
from ...core.scalars import UUID, MoneyScalar
...
class OrderCapture(BaseMutation):
    ...
    class Arguments:
        ...
        amount = MoneyScalar(required=True, description="Amount of money to capture.")
...
class OrderRefund(BaseMutation):
    ...
    class Arguments:
        ...
        amount = MoneyScalar(required=True, description="Amount of money to refund.")
