...
ShopErrorCode = graphene.Enum.from_enum(error_codes.ShopErrorCode)
ShippingErrorCode = graphene.Enum.from_enum(error_codes.ShippingErrorCode)
PaymentErrorCode = graphene.Enum.from_enum(error_codes.PaymentErrorCode)
GiftcardErrorCode = graphene.Enum.from_enum(error_codes.GiftcardErrorCode)
ExtensionsErrorCode = graphene.Enum.from_enum(error_codes.ExtensionsErrorCode)
