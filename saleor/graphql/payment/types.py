...
class TransactionEvent(ModelObjectType[models.TransactionEvent]):
    ...
    created_automatically = graphene.Boolean(
        description=(
            "Indicates whether the event was created automatically by Saleor.\n\n"
            "Certain events are generated by Saleor when not explicitly created by "
            " the app. For instance, if the first event reported by the app is "
            "`CHARGE_SUCCESS`, Saleor will automatically add the preceding event "
            "`CHARGE_REQUEST`.\n\n"
            "This field helps distinguish events originating from the app from those "
