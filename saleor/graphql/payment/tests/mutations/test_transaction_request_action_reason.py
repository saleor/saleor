...
def test_transaction_request_refund_with_reason_reference_required_created_by_user(
    ...
    transaction_request_webhook.events.create(event_type="transaction_refund_requested")
...
def test_transaction_request_charge_rejects_reason_and_reference(
    ...
    transaction_request_webhook.events.create(event_type="transaction_charge_requested")
    transaction = transaction_item_generator(
        checkout_id=checkout.pk,
