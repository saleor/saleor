...
def test_product_variant_where_in_stock(
    ...
    variables = {
        ...
        "where": {"stockAvailability": "IN_STOCK", "ids": variant_ids},
    }
...
def test_product_variant_where_out_of_stock(
    ...
    variables = {
        "channel": channel_USD.slug,
        "where": {"stockAvailability": "OUT_OF_STOCK", "ids": variant_ids},
    }
    ...
    out_of_stock_variants = (
        ...
        .filter(id__in={variant.id for variant in product_variant_list})
