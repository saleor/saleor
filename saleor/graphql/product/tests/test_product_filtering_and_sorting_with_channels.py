    ...
    ProductChannelListing.objects.bulk_create(
        [
            ...
            ProductChannelListing(
                ...
                publication_date=datetime.datetime(2000, 1, 1, tzinfo=pytz.UTC),
            ),
            ProductChannelListing(
                product=products[2],
                channel=channel_USD,
                ...
                publication_date=datetime.datetime(1999, 1, 1, tzinfo=pytz.UTC),
            ),
            ProductChannelListing(
                product=products[3],
                channel=channel_USD,
            ...
            ProductChannelListing(
                ...
                is_published=True,
                discounted_price_amount=Decimal(7),
                publication_date=datetime.datetime(1998, 1, 1, tzinfo=pytz.UTC),
            ),
        ]
    )
