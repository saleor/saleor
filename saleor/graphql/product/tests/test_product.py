            ...
            "values": [
                {
                    ...
                    "file": {
                        "url": f"http://testserver/file_upload"
...
def test_create_product_with_file_attribute_new_attribute_value(
    ...
    expected_attributes_data = [
        {"attribute": {"slug": color_attribute.slug}, "values": []},
        {
            ...
            "values": [
                {
                    "name": non_existing_value.split("/")[-1],
                    ...
                    "dateTime": None,
                    "file": {
                        "url": f"http://testserver/file_upload{non_existing_value}",
                        "contentType": None,
                    },
                }
            ],
...
def test_update_product_with_file_attribute_value(
    ...
    expected_file_att_data = {
        ...
        "values": [
            {
                "id": ANY,
                "name": new_value.split("/")[-1],
                "slug": slugify(new_value),
                "reference": None,
                "file": {
                    "url": f"http://testserver/file_upload{new_value}",
                    "contentType": None,
                },
                "boolean": None,
            }
        ...
        "values": [
            {
                ...
                "reference": None,
                "file": {
                    "url": f"http://testserver{existing_value.file_url}",
