...
def filter_products_by_variant_price(
    qs, channel_slug=None, price_lte=None, price_gte=None
):
...
def filter_products_by_minimal_price(
    qs, channel_slug=None, minimal_price_lte=None, minimal_price_gte=None
):
