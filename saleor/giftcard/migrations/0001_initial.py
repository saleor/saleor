    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_balance', django_prices.models.MoneyField(currency='USD', decimal_places=2, max_digits=12)),
                ('current_balance', django_prices.models.MoneyField(currency='USD', decimal_places=2, max_digits=12)),
