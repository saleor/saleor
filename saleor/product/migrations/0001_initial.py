    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', django_prices.models.AmountField(currency=b'USD', verbose_name='discount value', max_digits=12, decimal_places=2)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('price', django_prices.models.AmountField(currency=b'USD', verbose_name='price', max_digits=12, decimal_places=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_override', django_prices.models.AmountField(decimal_places=2, currency=b'USD', max_digits=12, blank=True, null=True, verbose_name='price override')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_price', django_prices.models.AmountField(decimal_places=2, currency=b'USD', max_digits=12, blank=True, null=True, verbose_name='cost price')),
