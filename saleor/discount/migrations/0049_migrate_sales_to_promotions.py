...
def create_catalogue_predicate(sale):
    collection_ids = [pk for pk in sale.collections.values_list("pk", flat=True)]
    category_ids = [pk for pk in sale.categories.values_list("pk", flat=True)]
    product_ids = [pk for pk in sale.products.values_list("pk", flat=True)]
    variant_ids = [pk for pk in sale.variants.values_list("pk", flat=True)]
