...
# TODO: Add token to transactions and filter charge back from transactions
# TODO: Create a card and add address for fraud detection
# TODO: Add fraud details as https://github.com/mirumee/django-payments/blob/master/payments/stripe/forms.py


def get_client_token(**_):
    """Not implemented for stripe gateway currently. The client token can
