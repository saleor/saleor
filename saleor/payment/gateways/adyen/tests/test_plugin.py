...
from ....utils import create_payment, create_payment_information, create_transaction
...
def adyen_plugin(settings):
    def fun(
        ...
        merchant_account = merchant_account or "SaleorECOM"  # "test_merchant"
        return_url = return_url or "http://127.0.0.1:3000/"  # "test_return_url"
        origin_key = (
            origin_key or "test_origin_key"
        )  # "pub.v2.8015947108133280.aHR0cDovLzEyNy4wLjAuMTozMDAw.F13B5vHDsUw4vWEkRTUMUfICGgkS_Vdu4EbpiqZY6OU"
        origin_url = origin_url or "http://127.0.0.1:3000"  # "test_origin_url"
