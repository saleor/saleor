...
def transactions_to_release_funds():
    ...
    The function retrieves checkouts that are automatically refundable and have exceeded
    the predefined TTL. It then fetches related transactions that are authorized
    or charged, ready for fund release.
    """
