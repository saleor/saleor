...
def test_create_transaction_event_from_request_and_webhook_resp_no_psp_ref_valid_event(
...
def test_create_transaction_event_from_request_and_webhook_resp_no_pspref_invalid_event(
    event_type,
    result_event_type,
    transaction_item_generator,
    app,
