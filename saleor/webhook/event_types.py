...
class WebhookEventAsyncType:
    ...
    PERMISSIONS = {
        ...
        ATTRIBUTE_CREATED: PageTypePermissions.MANAGE_PAGE_TYPES_AND_ATTRIBUTES,
        ATTRIBUTE_UPDATED: PageTypePermissions.MANAGE_PAGE_TYPES_AND_ATTRIBUTES,
        ATTRIBUTE_DELETED: PageTypePermissions.MANAGE_PAGE_TYPES_AND_ATTRIBUTES,
