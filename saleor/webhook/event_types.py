...
class WebhookEventAsyncType:
    ...
    DISPLAY_LABELS = {
        ...
        PAYMENT_ACTION_REQUEST: "Payment action request",
    ...
    CHOICES = [
        ...
        (PAYMENT_ACTION_REQUEST, DISPLAY_LABELS[PAYMENT_ACTION_REQUEST]),
    ...
    PERMISSIONS = {
        ...
        PAYMENT_ACTION_REQUEST: PaymentPermissions.HANDLE_PAYMENTS,
