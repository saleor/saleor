...
class WebhookEventAsyncType:
    ...
    CHOICES = [
        ...
        (PRODUCT_VARIANT_METADATA_UPDATED, DISPLAY_LABELS[PRODUCT_VARIANT_METADATA_UPDATED]),
        ...
        (SHIPPING_ZONE_METADATA_UPDATED, DISPLAY_LABELS[SHIPPING_ZONE_METADATA_UPDATED]),
        ...
        (TRANSACTION_ITEM_METADATA_UPDATED, DISPLAY_LABELS[TRANSACTION_ITEM_METADATA_UPDATED]),
