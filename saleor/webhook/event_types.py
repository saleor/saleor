...
class WebhookEventAsyncType:
    ...
    ROOT_TYPE = {
        ...
        APP_UPDATED: "App",
        APP_DELETED: "App",
        APP_STATUS_CHANGED: "App",
        ATTRIBUTE_CREATED: "Attribute",
        ATTRIBUTE_UPDATED: "Attribute",
        ATTRIBUTE_DELETED: "Attribute",
        ATTRIBUTE_VALUE_CREATED: "Attribute",
        ATTRIBUTE_VALUE_UPDATED: "Attribute",
        ATTRIBUTE_VALUE_DELETED: "Attribute",
        ...
        CHANNEL_STATUS_CHANGED: "Channel",
        GIFT_CARD_CREATED: "GiftCard",
        GIFT_CARD_UPDATED: "GiftCard",
        GIFT_CARD_DELETED: "GiftCard",
        GIFT_CARD_STATUS_CHANGED: "GiftCard",
        GIFT_CARD_METADATA_UPDATED: "GiftCard",
        MENU_CREATED: "Menu",
        MENU_UPDATED: "Menu",
        MENU_DELETED: "Menu",
        MENU_ITEM_CREATED: "MenuItem",
        MENU_ITEM_UPDATED: "MenuItem",
        MENU_ITEM_DELETED: "MenuItem",
        ORDER_CREATED: "Order",
        ...
        ORDER_METADATA_UPDATED: "Order",
        DRAFT_ORDER_CREATED: "Order",
        DRAFT_ORDER_DELETED: "Order",
        DRAFT_ORDER_UPDATED: "Order",
        SALE_CREATED: "Sale",
        SALE_UPDATED: "Sale",
        SALE_DELETED: "Sale",
        SALE_TOGGLE: "Sale",
        ...
        CUSTOMER_METADATA_UPDATED: "User",
        COLLECTION_CREATED: "Collection",
        COLLECTION_UPDATED: "Collection",
        COLLECTION_DELETED: "Collection",
        COLLECTION_METADATA_UPDATED: "Collection",
        PRODUCT_CREATED: "Product",
        PRODUCT_UPDATED: "Product",
        PRODUCT_DELETED: "Product",
        PRODUCT_METADATA_UPDATED: "Product",
        PRODUCT_VARIANT_CREATED: "Product",
        PRODUCT_VARIANT_UPDATED: "Product",
        PRODUCT_VARIANT_DELETED: "Product",
        PRODUCT_VARIANT_METADATA_UPDATED: "Product",
        PRODUCT_VARIANT_BACK_IN_STOCK: "Stock",
        PRODUCT_VARIANT_OUT_OF_STOCK: "Stock",
        CHECKOUT_CREATED: "Checkout",
        CHECKOUT_UPDATED: "Checkout",
        CHECKOUT_METADATA_UPDATED: "Checkout",
        ...
        PAGE_UPDATED: "Page",
        PAGE_DELETED: "Page",
        PAGE_TYPE_CREATED: "PageType",
        PAGE_TYPE_UPDATED: "PageType",
        PAGE_TYPE_DELETED: "PageType",
        PERMISSION_GROUP_CREATED: "PermissionGroup",
        PERMISSION_GROUP_UPDATED: "PermissionGroup",
        PERMISSION_GROUP_DELETED: "PermissionGroup",
        SHIPPING_PRICE_CREATED: "ShippingMethod",
        SHIPPING_PRICE_UPDATED: "ShippingMethod",
        SHIPPING_PRICE_DELETED: "ShippingMethod",
        SHIPPING_ZONE_CREATED: "ShippingZone",
        SHIPPING_ZONE_UPDATED: "ShippingZone",
        SHIPPING_ZONE_DELETED: "ShippingZone",
        SHIPPING_ZONE_METADATA_UPDATED: "ShippingZone",
        STAFF_CREATED: "User",
        STAFF_UPDATED: "User",
        STAFF_DELETED: "User",
        TRANSACTION_ACTION_REQUEST: "TransactionActionData",
        TRANSACTION_ITEM_METADATA_UPDATED: "TransactionItem",
        TRANSLATION_CREATED: "Translation",
        TRANSLATION_UPDATED: "Translation",
        VOUCHER_CREATED: "Voucher",
        VOUCHER_UPDATED: "Voucher",
        VOUCHER_DELETED: "Voucher",
        VOUCHER_METADATA_UPDATED: "Voucher",
