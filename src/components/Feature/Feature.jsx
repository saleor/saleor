      ...
      <section className="features section-container">
        <div className="grid icons">
          ...
          <div className="icon-card">
            ...
            <p>Take advantage of the robust API that gives you access to any third-party integrations you want. Build a mobile app, customize your storefront or externalize processes such as inventory management, order
      ...
      <section className="management-section grid">
        ...
        <div className="card-grid col-lg-8 col-md-6 col-sm-12 col-xs-12">
          <div className="icon-card">
              ...
              <p>Collect payments using global payment providers like PayPal or&nbsp;Braintree.</p>
            </div>
            <div className="icon-card">
