...
class Home extends Component {
  ...
  isVisibleBuildToScale(isVisible) {
    if (isVisible) {
      this.setState(prevState => ({
        buildToScaleBig: { ...prevState.buildToScaleBig, isPaused: false }
      }));
    }
  }
  ...
  isVisibleEasyToCustomize(isVisible) {
    if (isVisible) {
      this.setState(prevState => ({
        easyToCustomizeBig: { ...prevState.easyToCustomizeBig, isPaused: false }
      }));
    }
  }
    ...
    return (
      <div id="home" className="container">
        <Helmet>
          ...
          <meta
            name="description"
            content="A GraphQL-first eCommerce platform for perfectionists. It is open sourced, PWA-ready and looks beautiful. Find out why developers love it."
          />
        </Helmet>
            ...
            {this.state.newsBar && (
              <div className="news">
                ...
                <div className="content">
                  <a
                    href="http://bit.ly/AprilRelease2019"
                    target="_blank"
                    rel="noopener"
                  >
                    <strong>April Release of Saleor</strong>
                  </a>
                  <div className="close-icon" onClick={this.toggleNewsBar} />
                </div>
              </div>
            )}
            <h1>
              A graphql-first ecommerce{" "}
              <span className="primaryColor">platform for perfectionists</span>
            </h1>
            <div className="button-wrapper">
              <a
                href="https://demo.getsaleor.com/"
                target="_blank"
                rel="noopener"
              ...
              <a
                href="https://mirumee.typeform.com/to/Xwfril"
                target="_blank"
                rel="noopener"
        ...
        <section id="features-section" className="features">
            ...
            <div className="grid icons">
              <div className="col-xs-6 col-sm-6 col-md-3 software-stack">
                <a href="#software-stack">
                  <div
                    className="image"
                    onMouseEnter={this.modernStackEnter}
                    onMouseLeave={this.modernStackLeave}
                  >
                    <Lottie
                      options={modernStackOptions}
              ...
              <div className="col-xs-6 col-sm-6 col-md-3 build-to-scale">
                <a href="#build-to-scale">
                  <div
                    className="image"
                    onMouseEnter={this.buildToScaleEnter}
                    onMouseLeave={this.buildToScaleLeave}
                  >
                    <Lottie
                      options={buildToScaleOptions}
              ...
              <div className="col-xs-6 col-sm-6 col-md-3 easy-to-customize">
                <a href="#easy-to-customize">
                  <div
                    className="image"
                    onMouseEnter={this.easyToCustomizeEnter}
                    onMouseLeave={this.easyToCustomizeLeave}
                  >
                    <Lottie
                      options={easyToCustomizeOptions}
              ...
              <div className="col-xs-6 col-sm-6 col-md-3 user-experience">
                <a href="#user-experience">
                  <div
                    className="image"
                    onMouseEnter={this.greatExperienceEnter}
                    onMouseLeave={this.greatExperienceLeave}
                  >
                    <Lottie
                      options={greatExperienceOptions}
          ...
          <div className="section-container">
            <div
              id="software-stack"
              className="grid feature-item software-stack"
            >
              <div className="col-xs-12 col-sm-6 col-md-6 text">
                <h2>01. State of the art software stack</h2>
                <p>
                  Saleor is powered by a GraphQL server running on top of
                  Python&nbsp;3 and a Django&nbsp;2&nbsp;framework
                </p>
                <p className="text-light">
                  Both the storefront and the dashboard are React applications
                  written in TypeScript and use Apollo GraphQL. Strict quality
                  checks and reviews make the code easy to read and understand.
                  High test coverage ensures it’s also safe to deploy in a
                  continuous&nbsp;manner.
                </p>
              </div>
            ...
            <div
              id="build-to-scale"
              className="grid feature-item build-to-scale"
            >
              <Fade bottom when={true} appear={!isMobileOnly} duration={1500}>
                <div className="col-xs-12 col-sm-6 col-md-6 image">
              ...
              <div className="col-xs-12 col-sm-6 col-md-6 text">
                ...
                <p>
                  Serve millions of products and thousands of customers without
                  breaking a&nbsp;sweat
                </p>
                <p className="text-light">
                  Saleor is optimized for cloud deployments using Docker.
                  Horizontal scalability allows Saleor to take advantage of
                  platforms such as AWS and Google&nbsp;Cloud and adapt to your
                  traffic. Multi-container deployments allow your software to
                  scale without downtime. Persistent GraphQL Queries take
                  advantage of CDN to ensure snappy performance under even the
                  heaviest of&nbsp;loads.
                </p>
              </div>
            </div>
            <div
              ...
              className="grid feature-item easy-to-customize"
            >
              <div className="col-xs-12 col-sm-6 col-md-6 text">
                <h2>03. Easy to customize</h2>
                <p>
                  Saleor delivers ecommerce even when you need more than an
                  out-of-the-box solution
                </p>
                <p className="text-light">
                  Take it even further to automate any process like ordering,
                  shipping or payment. Whether you’re a local florist or a
                  government agency, Saleor is a solid Django based foundation
                  to build and deliver bespoke solutions to your specific
                  problems. Build the store that you want instead of trying to
                  bend your requirements around enterprise&nbsp;platforms.
                </p>
              </div>
              <Fade bottom when={true} appear={!isMobileOnly} duration={1500}>
                <div className="col-xs-12 col-sm-6 col-md-6 image">
            ...
            <div
              id="user-experience"
              className="grid feature-item user-experience"
            >
              <div className="col-xs-12 col-sm-12 col-md-12 text">
                <h2>04. User experience that simply&nbsp;rocks</h2>
                <p>
                  The user experience with Saleor is more than you ever expect
                  from open source, rivalling the very best
              ...
              <div className="col-xs-12 col-sm-6 col-md-6 storefront">
                <Fade bottom when={true} appear={!isMobileOnly} duration={1300}>
                  <img
                    src={storefrontIcon}
                    srcSet={`${storefrontIcon} 1x, ${storefrontIconX2} 2x, ${storefrontIconX3} 3x`}
                    alt="storefont screen"
                  />
                </Fade>
                <h2>Storefront</h2>
                <p>
                  Saleor takes advantage of PWA standards to optimize mobile
                  experiences of the rapidly growing group of people shopping on
                  the&nbsp;run.
                </p>
                <p className="text-light">
                  Allow your customers to buy their next pair of jeans while
                  enjoying a virgin margarita on a plane. They will only need an
                  internet connection when they go to pay with Apple Pay or one
                  of the cards stored by their&nbsp;phone.{" "}
                </p>
                <a href="https://demo.getsaleor.com" target="blank">
                  See Storefront
                </a>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-6 dashboard">
                <Fade bottom when={true} appear={!isMobileOnly} duration={1600}>
                  <img
                    src={dashboardIcon}
                    srcSet={`${dashboardIcon} 1x, ${dashboardIconX2} 2x, ${dashboardIconX3} 3x`}
                    alt="dashboard screen"
                  />
                </Fade>
                <h2>Dashboard</h2>
                <p>
                  Easy-to-use dashboard makes managing your store a pleasant
                  experience whether you’re using the latest Macbook or a
                  two-year-old&nbsp;smartphone.
                </p>
                <p className="text-light">
                  Its intuitive interface is designed to aid your staff in daily
                  routines like order management, inventory tracking or
                  reporting. Saleor dashboard’s friendly home screen will also
                  suggest items that may need your attention so you always stay
                  on top of&nbsp;things.
                </p>
                <a
                  href="https://demo.getsaleor.com/en/account/login/"
                  target="blank"
                >
                  See Dashboard
                </a>
          ...
          <div className="section-container">
            <div className="grid">
              <div className="col-xs-12 col-sm-12 col-md-7 text">
                <h2>Open source</h2>
                <p>
                  Join our open source community <br />& change e-commerce
                </p>
                <p className="text-light">
                  Gain access to core contributors and the latest discussions.
                  Become part of the world’s fastest growing open source
                  e-commerce platform{" "}
                </p>
            ...
            <div className="community-links">
              ...
              <div className="icons">
                <a href="https://gitter.im/mirumee/saleor" target="_blank">
                  <ReactSVG
                    className="gitter-icon logo"
                    path="images/gitter-icon.svg"
                  />
                </a>
                <a href="https://medium.com/saleor" target="_blank">
                  <ReactSVG
                    className="medium-icon logo"
                    path="images/medium-icon.svg"
                  />
                </a>
                <a
                  href="https://www.transifex.com/mirumee/saleor-1/"
                  target="_blank"
                >
                  <ReactSVG
                    className="transifex-icon"
                    path="images/transifex-icon.svg"
                  />
                </a>
                <a
                ...
                >
                  <ReactSVG
                    className="stackoverflow-icon logo"
                    path="images/stackoverflow-icon.svg"
                  />
                </a>
              </div>
            </div>
            ...
            >
              <div className="grid head">
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xlg-12">
                  <h2 className={`tab-${this.state.tabIndex}`}>
                    Saleor in action
                  </h2>
                </div>
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xlg-12">
                  <TabList className="tabs grid">
                    <Tab className="col-xs-6 col-sm-6 col-md-6">
                      ...
                      <div
                        className={`border-skew tab-${this.state.tabIndex}`}
                      />
                    </Tab>
                    <Tab className="col-xs-6 col-sm-6 col-md-6">
              ...
              <TabPanel className="case-study">
                <div className="grid">
                  <div className="col-xs-12 col-sm-12 col-md-6">
                    <img
                      src={pgShowCase}
                      srcSet={`${pgShowCase} 1x, ${pgShowCaseX2} 2x, ${pgShowCaseX3} 3x`}
                      alt="Pretty Green showcase"
                    />
                  </div>
                  <div className="col-xs-12 col-sm-12 col-md-6">
                    <div className="pg-quote">
                      ...
                      <p>
                        “The response time of the website has improved
                        dramatically. We’re down below the 1-second mark whereas
                        previously we were 3.5-4 seconds on average. We've also
                        been able to maintain that response time during
                      ...
                      <a
                        className="btn btn-secondary"
                        href="https://www.prettygreen.com/"
                        target="_blank"
                        rel="noopener"
                      >
                  ...
                  <div className="col-xs-12 col-sm-12 col-md-6 item patchGarden">
                    ...
                    <div className="grid">
                      <div className="col-xs-6 col-sm-6 col-md-12">
                        <ReactSVG
                          className="logo"
                          path="images/patchgreen-logo.svg"
                        />
                      </div>
                      <div className="col-xs-6 col-sm-6 col-md-12 link">
                        <a
        ...
        <section className="enterprice-consulting">
          <div className="section-container">
            ...
            <h4>
              If you need a custom solution and extra code, our team can also
              help.
            </h4>
            <div className="list grid">
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-5">
                <ul>
                  <li>
                    <span>
                      if you're looking for b2b or entreprise solutions
                    </span>
                  </li>
                  <li>
                    <span>if a licensed platform is not enough</span>
                  </li>
                  <li>
                    <span>if you’re outgrowing your existing solution</span>
                  </li>
                </ul>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-7 list-item">
                <ul>
                  <li>
                    <span>if you need unlimited integration possibilities</span>
                  </li>
                  <li>
                    <span>if you’re a high-volume business</span>
                  </li>
                  <li>
                    <span>
                      if you need a reliable and secure implementation
                    </span>
                  </li>
                </ul>
              </div>
