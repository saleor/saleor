    ...
    <section id="roadmap-section" className="roadmap-content">
      ...
      <div className="grid roadmap-item">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/december-release-of-saleor-263c77e4651c" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <h4>Maintenance</h4>
          <a href="https://medium.com/saleor/november-release-of-saleor-20648dc53804" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/saleor-2-0-release-graphql-first-headless-e-commerce-1330f2151585" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/september-release-of-saleor-a7828751ec9" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/summer-release-of-saleor-dashboard-2-0-preview-14bbe69c0f58" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/june-release-of-saleor-graphql-is-here-bf55cc8b500" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/may-release-of-saleor-getting-ready-for-gdpr-4bcb8c99438d" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/april-release-of-saleor-vat-support-is-here-e27ff6de8e90" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/march-release-of-saleor-c3c1e4c03406" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
        ...
        <div className="col-xs-8 col-sm-8 col-md-8 text">
          ...
          <a href="https://medium.com/saleor/february-release-of-saleor-21c586c7c5ce" target="_blank">Read article</a>
        </div>
      </div>
      <div className="grid roadmap-item">
        <div className="col-xs-3 col-sm-3 col-md-3 line">
