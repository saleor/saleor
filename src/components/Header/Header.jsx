...
class Header extends Component {
  constructor(props) {
    super(props);
    const { cookies } = props;
    const visiblePrivacyPolicyBar = cookies.get("privacypolicybar")
      ? false
      : true;
    this.state = {
      mobileMenu: false,
  ...
  handleScroll = () => {
    ...
    const { scrollDirection, sticky } = this.state;
    ...
    if (scrollPosition > 120 && !sticky) {
      this.setState({ sticky: true });
    } else if (scrollPosition <= 120 && sticky) {
  ...
  render() {
    return (
      <header
        className={
          this.state.sticky ? "sticky " + this.state.scrollDirection : null
        }
      >
        {this.state.visibleNewsBar ? (
          <div className="news">
            <div className="content">
              <a href="https://medium.com/p/1330f2151585" target="_blank">
                Saleor 2.0 release is out.{" "}
                <span className="text-underline">Check out what's new!</span>
              </a>
            ...
            <div
              className={
                this.state.mobileMenu
                  ? "logo open col-xs-3 col-ls-6 col-sm-6 col-md-3 col-lg-6 col-xlg-8"
                  : "logo col-xs-3 col-sm-6 col-md-3 col-lg-6 col-xlg-8"
              }
            >
              <NavLink to="/" aria-label="Saleor Logo">
                <ReactSVG className="logo-svg" path="images/saleor-logo.svg" />
              </NavLink>
            </div>
            <nav
              className={
                this.state.visibleNewsBar
                  ? "menu newsbar col-xs-9 col-ls-6 col-sm-6 col-md-9 col-lg-6 col-xlg-4"
                  : "menu col-xs-9 col-sm-6 col-md-9 col-lg-6 col-xlg-4"
              }
            >
              <ul
                className={
                  this.state.mobileMenu ? "menu-mobile hovered" : "menu-desktop"
                }
              >
                <li>
                ...
                <li className="underline">
                  ...
                  <NavLink to="/features" onClick={this.closeMenu}>
                    Features
                  </NavLink>
                </li>
                <li className="underline">
                  <span className="count">03. </span>
                  <NavLink to="/roadmap" onClick={this.closeMenu}>
                    Roadmap
                  </NavLink>
                </li>
                <li
                  className={
                    this.state.subMenu ? "background open" : "background"
                  }
                >
                  <span className="count">05. </span>
                  <a href="" onClick={e => this.toggleSubMenu(e)}>
                    Developers{" "}
                    <span className="trangleContainer">
                      <span className="triangle" />
                    </span>
                  </a>
                  <div
                    className={this.state.subMenu ? "submenu open" : "submenu"}
                  >
                    <div className="item">
                      <a
                    ...
                    <div className="item">
                      <a
                        href="https://gitter.im/mirumee/saleor"
                        target="_blank"
                        rel="noopener"
                      >
                        <div className="icon">
                          <ReactSVG
                            className="gitter-icon"
                ...
                <li>
                  ...
                  <a
                    className={this.state.mobileMenu ? null : "contactBtn"}
              ...
              <ul className="mobile-btn">
                ...
                <li
                  className={
                    this.state.mobileMenu ? "menu-icon open" : "menu-icon"
                  }
                  onClick={this.toggleMenu}
                >
                  <span />
          ...
          <div className="notification">
            <div className="content">
              ...
              <p className="privacyPolicyText">
                By accepting our usage of third-party software such as HotJar,
                you help us to deliver a better website experience to all our
                users. To see our full privacy policy,{" "}
                <a
              ...
              <h5 className="acceptButton" onClick={this.closePrivacyPolicyBar}>
                ACCEPT
              </h5>
              <img
                className="cookieAcceptImg"
                src={cookieAcceptImg}
                onClick={this.closePrivacyPolicyBar}
              />
            </div>
          </div>
        ) : null}
