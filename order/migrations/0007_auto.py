...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'order_order_payments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'order.order'], null=False)),
            ('payment', models.ForeignKey(orm[u'payments.payment'], null=False))
        ))
        db.create_unique(u'order_order_payments', ['order_id', 'payment_id'])


    def backwards(self, orm):
        # Removing M2M table for field payments on 'Order'
        db.delete_table('order_order_payments')
    ...
    models = {
        ...
        u'order.order': {
            ...
            'payments': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['payments.Payment']", 'symmetrical': 'False'}),
